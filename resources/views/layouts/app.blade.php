<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" xmlns="http://www.w3.org/1999/XSL/Transform" xmlns="">
<head>
    <meta charset="utf-8">
                        ...
                        @else
                            ...
                            <dropdown align="right" width="200px">
                                <template v-slot:trigger>
                                    <button class="button flex items-center text-default no-underline text-sm">
                                        <img width="35"
